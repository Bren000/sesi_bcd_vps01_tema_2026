...
VALUES
('Ana Souza', 'ana@empresa.com', '11999990001', 'Financeiro', 'Analista', 'Ativo'),
('Bruno Lima', 'bruno@empresa.com', '11999990002', 'RH', 'Assistente', 'Ativo'),
('Carla Mendes', 'carla@empresa.com', '11999990003', 'Vendas', 'Gerente', 'Ativo')


INSERT INTO tecnico
(nome, email, especialidade, status)
VALUES
('João Silva', 'joao@empresa.com', 'Hardware', 'Ativo'),
('Marcos Oliveira', 'marcos@empresa.com', 'Redes', 'Ativo'),
('Fernanda Costa', 'fernanda@empresa.com', 'Software', 'Ativo')
